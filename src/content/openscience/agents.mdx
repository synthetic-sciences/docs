---
title: "Agents"
description: "Use the default research agent, domain specialists, review agents, read-only planning, or a custom profile."
icon: "bot"
---
...
| --- | --- | --- |
| `research` | Default | Literature, data analysis, compute, and research synthesis across the full skill set. |
...
| `ml` | Specialist | Trains, evaluates, and analyzes deep learning, language, classical ML, and reinforcement learning models. |
...
| --- | --- |
| `critique` | Read-only scientific critique. Checks data leakage, statistics, and unsupported claims before expensive or irreversible actions. |
...
`--tools "read,grep,glob"` produces a read-only profile without edit tools. Run `openscience agent create --help` to see the tool names available in your installed version.
...
<Columns cols={2}>
  <Card title="Skills" icon="book-open" href="/openscience/skills">
    The 290+ skill library the agents draw on.
  </Card>
