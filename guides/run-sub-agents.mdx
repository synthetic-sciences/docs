...
<Steps>
  ...
  <Step title="The sub-agent executes">
    ...
    | `THESIS_PROJECT_SKILLS_JSON` | The mounted skill snapshot at the time of spawn |
    | `THESIS_PROJECT_SKILLS_PROMPT` | A prompt-formatted version of the mounted skills |
    | `THESIS_SKILLS_DIR` | Path to the mounted skill directory inside the project filesystem |
