...
<CardGroup cols={3}>
  <Card title="gpu-a10g" icon="microchip">
    NVIDIA A10G. Suitable for most inference and medium-scale training workloads. Good balance of cost and capability for experiments that don't require the largest memory footprint.
  </Card>
  <Card title="gpu-a100-40gb" icon="microchip">
    NVIDIA A100 (40 GB HBM2). High-memory GPU for larger models, fine-tuning runs, and experiments with large batch sizes or long context.
  </Card>
  <Card title="gpu-h100" icon="microchip">
    NVIDIA H100. Highest-performance option, designed for demanding training workloads, large model inference, and time-sensitive experiments.
  </Card>
</CardGroup>
