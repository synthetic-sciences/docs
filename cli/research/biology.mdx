...
<iframe
  ...
  src="https://www.youtube.com/embed/_d_jUR429F4?rel=0&modestbranding=1"
  title="Biology mode walkthrough"
  frameBorder="0"
...
```bash
synci run --mode biology "Predict structures for these 12 protein sequences with ESMFold and rank by pLDDT"
```
