---
title: "Install Synsci CLI in one command"
...
<Tip>
  After `npx synsci` finishes, run `synsc web` to open the recommended browser UI, see the [Web UI page](/cli/web). The TUI and desktop app are both still available if you prefer them.
</Tip>
...
<Tabs>
  ...
  <Tab title="Homebrew (macOS)">
    ...
    Apple Silicon and Intel both supported. Updates via `brew upgrade synsc`.
  </Tab>
...
A separate native app for macOS, Windows, and Linux is available if you'd rather have a full windowed UI than `synsc web`. Download from the [GitHub releases page](https://github.com/synthetic-sciences/synsci-cli/releases). See [Desktop app](/cli/desktop) for details.
...
- **[Web UI](/cli/web).** `synsc web`, the recommended way to use Synsci CLI day-to-day.
