...
The desktop app is the standalone alternative to [`synsc web`](/cli/web). Same agent, same modes, same tools, same credentials, just packaged as a native application rather than a browser-served UI. Pick it if you'd rather have the agent in a dedicated window than a browser tab.
