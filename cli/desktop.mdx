...
description: "Native desktop app for Synsci CLI. Same agent surface as the web UI and TUI, wrapped as a standalone application. macOS, Windows, and Linux."
sidebarTitle: "Desktop app"
---

The desktop app is the standalone alternative to [`synsc web`](/cli/web). Same agent, same models, same skills, same credentials — just packaged as a native application rather than a browser-served UI. Pick it if you'd rather have the agent in a dedicated window than a browser tab.
...
|---|---|
| Daily development with multi-tab sessions | [Web UI (`synsc web`)](/cli/web) |
...
<CardGroup cols={2}>
  <Card title="Web UI" icon="window" href="/cli/web">
    The recommended interface — `synsc web` runs the same surface as a browser tab.
  </Card>
