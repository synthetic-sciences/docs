...
Each call consumes credits proportional to the input and output tokens. The cost is computed from the active research mode and the work the agent performed. You see the cost in the dashboard and in `synsc stats`.
