...
- **Bundled skills** — the 83 ML skills baked into the binary.
...
<CardGroup cols={2}>
  <Card title="Thesis MCP overview" icon="diagram-project" href="/mcp/quickstart">
    The 86-tool MCP surface from the Thesis side.
  </Card>
  <Card title="Synsci CLI agents" icon="robot" href="/cli/agents">
    The build/plan/@general split — choose carefully when an agent has both terminal and graph access.
  </Card>
</CardGroup>
