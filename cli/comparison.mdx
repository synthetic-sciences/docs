...
description: "How Synsci CLI compares to general-purpose terminal agents. Research modes, bundled scientific skills, native cloud sync, and included credits."
...
|---|---|---|---|---|
| **Research modes** | Yes (chemistry, biology, physics, materials, ML, math) | None | None | None |
| **Bundled scientific skills** | Hundreds across all modes | None bundled | Plugin marketplace | None bundled |
...
- Skill activation by trigger phrase rather than explicit invocation.
