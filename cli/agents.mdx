---
title: "Synci CLI agents: build, plan, and @general"
...
Synci CLI ships with two top-level agent modes and one delegated subagent. The split is deliberate.
...
```bash
synci web                    # recommended browser UI
synci                        # alternative TUI
```
...
- **[Research](/cli/research/research)**, **[physics](/cli/research/physics)**, **[chemistry](/cli/research/chemistry)**, **[biology](/cli/research/biology)**, **[write](/cli/research/write)**, **[flywheel](/cli/research/flywheel)**. Modes are orthogonal to agents. Pick one of each.
